...
from simulation_element import ReverseRelatedMethod, Car, ReverseGarage, CarController
...
if __name__ == '__main__':
    ...
    end_status = [m_garage.get_h() + m_garage.get_w() / 2, m_garage.get_l() / 2, 90]
    ...
    m_controller = CarController(m_car, fig, ax)
    plt.show()
